import { z } from "zod";
import { DocumentNatureSchema, DocumentTypeSchema, EvaluatedLegalStatusSchema, LegalEventTypeSchema, TaxTopicSchema, VerificationStatusSchema, } from "./taxonomy.js";
/**
 * 66. MCP Error Codes
 */
...
export const OfficialGuidanceItemSchema = z.object({
    ...
    evidence: z.array(EvidenceItemSchema),
    note: z.string().default("Official guidance reflects administrative execution interpretation and is not a normative legal document (VBQPPL)."),
});
